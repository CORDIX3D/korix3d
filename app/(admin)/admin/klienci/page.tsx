...
export const metadata = {
  title: 'Klienci | Panel administratora KORIX3D',
  description: 'Lista kont klientów i podstawowych danych kontaktowych.',
};
  ...
  return (
    <GenericAdminCrud
      config={{
        ...
        allowCreate: false,
        searchKeys: ['email', 'full_name', 'phone', 'company'],
        fields: [
          ...
          { key: 'address_city', label: 'Miasto' },
          { key: 'address_zip', label: 'Kod pocztowy' },
        ],
        defaultInsert: { address_country: 'Polska' },
        columns: [
          { key: 'full_name', label: 'Klient' },
          { key: 'email', label: 'Email' },
          { key: 'phone', label: 'Telefon' },
          { key: 'company', label: 'Firma' },
          { key: 'role', label: 'Rola', type: 'status' },
