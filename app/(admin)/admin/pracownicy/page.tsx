...
export const metadata = {
  title: 'Pracownicy | Panel administratora KORIX3D',
  description: 'Konta pracowników i administratorów KORIX3D.',
};
...
export default function Page() {
  return (
    <GenericAdminCrud
      config={{
        title: 'Pracownicy',
        description: 'Konta pracowników i administratorów.',
        table: 'profiles',
        orderBy: 'created_at',
        ...
        fields: [
          ...
          { key: 'company', label: 'Dział / firma' },
        ],
        defaultInsert: { address_country: 'Polska' },
        columns: [
          { key: 'full_name', label: 'Osoba' },
