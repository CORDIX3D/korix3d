...
export const metadata = {
  title: 'Powiadomienia | Panel administratora KORIX3D',
  description: 'Podgląd i obsługa powiadomień użytkowników KORIX3D.',
};
...
export default function Page() {
  return (
    <GenericAdminCrud
      config={{
        title: 'Powiadomienia',
        description: 'Podgląd i obsługa powiadomień użytkowników.',
        table: 'notifications',
        orderBy: 'created_at',
        addLabel: 'Dodaj powiadomienie',
        allowCreate: false,
        searchKeys: ['title', 'message', 'type'],
        fields: [
          { key: 'user_id', label: 'ID użytkownika UUID', required: true, readOnlyOnEdit: true },
