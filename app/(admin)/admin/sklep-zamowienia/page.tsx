  ...
  return (
    <GenericAdminCrud
      config={{
        ...
        fields: [
          { key: 'customer_email', label: 'Email klienta', type: 'email', required: true },
          ...
          { key: 'subtotal', label: 'Produkty', type: 'number', required: true, defaultValue: 0 },
          { key: 'shipping_cost', label: 'Dostawa', type: 'number', defaultValue: 0 },
          { key: 'vat_amount', label: 'VAT', type: 'number', defaultValue: 0 },
          { key: 'total', label: 'Razem', type: 'number', required: true, defaultValue: 0 },
