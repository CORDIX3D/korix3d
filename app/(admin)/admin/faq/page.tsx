...
export const metadata = {
  title: 'FAQ | Panel administratora KORIX3D',
  description: 'Zarządzanie pytaniami i odpowiedziami widocznymi na stronie KORIX3D.',
};
...
export default function Page() {
  return (
    <GenericAdminCrud
      config={{
        title: 'FAQ',
        description: 'Pytania i odpowiedzi widoczne na stronie.',
        table: 'faq_items',
        orderBy: 'created_at',
