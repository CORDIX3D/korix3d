...
export const metadata = {
  title: 'Kolejka druku | Panel administratora KORIX3D',
  description: 'Planowanie i aktualizacja prac produkcyjnych KORIX3D.',
};
...
export default function Page() {
  return (
    <GenericAdminCrud
      config={{
        title: 'Kolejka druku',
        description: 'Planowanie i aktualizacja prac produkcyjnych.',
        table: 'orders_3d',
        orderBy: 'created_at',
        ...
        fields: [
          ...
          { key: 'assigned_to', label: 'Przypisane do' },
          { key: 'printing_time_hours', label: 'Szacowany czas h', type: 'number' },
          { key: 'filament_used_grams', label: 'Filament g', type: 'number' },
          { key: 'admin_notes', label: 'Instrukcje produkcyjne', type: 'textarea' },
        ],
        defaultInsert: { files: [], user_id: '00000000-0000-0000-0000-000000000000' },
        columns: [
          { key: 'order_number', label: 'Numer' },
          { key: 'status', label: 'Status', type: 'status' },
          { key: 'priority', label: 'Priorytet', type: 'status' },
          { key: 'assigned_to', label: 'Operator' },
          { key: 'printing_time_hours', label: 'Czas h', type: 'number' },
